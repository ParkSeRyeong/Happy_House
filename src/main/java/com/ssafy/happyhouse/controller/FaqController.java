...
import com.ssafy.happyhouse.model.service.FaqService;
...
public class FaqController {
	...
	public ResponseEntity<List<BoardDto>> listBoard() throws Exception {
		...
		return new ResponseEntity<List<BoardDto>>(faqService.list(), HttpStatus.OK);
	}
	...
	public ResponseEntity<BoardDto> searchBook(@PathVariable int no) {
		...
		return new ResponseEntity<BoardDto>(faqService.search(no), HttpStatus.OK);
	}
